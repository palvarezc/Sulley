...
//ClassImp(RooExpOfPolyTimesX) 

 RooExpOfPolyTimesX::RooExpOfPolyTimesX(const char *name, const char *title, 
                        RooAbsReal& _m,
                        RooAbsReal& _pT,
                        RooAbsReal& _l1,
                        RooAbsReal& _l2,
 ...
 RooExpOfPolyTimesX::RooExpOfPolyTimesX(const RooExpOfPolyTimesX& other, const char* name) :  
...
Double_t RooExpOfPolyTimesX::evaluate() const
{
...
Int_t RooExpOfPolyTimesX::getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& analVars, const char* rangeName) const
{
...
Double_t RooExpOfPolyTimesX::analyticalIntegral(Int_t code, const char* rangeName) const
{
   switch(code)
   {
      case 1:
