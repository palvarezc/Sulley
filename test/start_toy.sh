...
TRIGGER=1
N_TOYS=1
# BDT_VAR_NAME="B_plus_ETA"
# BDT_VAR_NAME="BDT1ETOSRun2"
BDT_VAR_NAME="BDT1ETOSRun1"
BDT_CUT=0.17  #-0.0187   0.297
...
$SULLEYROOT/bin/toystudy_ana $RELOAD_CTRL_SAMPLES $Y_SIG $Y_PART_RECO $Y_COMB $Y_JPSILEAK $TRIGGER $N_TOYS $BDT_VAR_NAME  $BDT_CUT $CONSTRAINED $MODE $OUTPUTDIR $WANT_HOP_CUT $MIN_B_MASS $MAX_B_MASS $run $N_KEMU $PPERP_CUT
