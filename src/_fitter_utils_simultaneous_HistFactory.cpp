#include "fitter_utils_simultaneous_HistFact.h"
...
FitterUtilsSimultaneousHistFact::FitterUtilsSimultaneousHistFact(int nGenKemu_, int nGenSignal_, int nGenPartReco_, 
                                                                 int nGenComb_, int nGenJpsiLeak_,
                                                                 double nGenFracZeroGamma_, double nGenFracOneGamma_, 
                                                                 string workspacename_)
   :FitterUtilsHistFact(nGenSignal_, nGenPartReco_, nGenComb_, nGenJpsiLeak_, 
                        nGenFracZeroGamma_, nGenFracOneGamma_, workspacename_), nGenKemu(nGenKemu_)
   {}


void FitterUtilsSimultaneousHistFact::initiateParams(int nGenSignalZeroGamma, int nGenSignalOneGamma, int nGenSignalTwoGamma,
...
{
  FitterUtilsHistFact::initiateParams(nGenSignalZeroGamma, nGenSignalOneGamma, nGenSignalTwoGamma,
...
void FitterUtilsSimultaneousHistFact::generate(bool wantPlots, string plotsfile)
{
   FitterUtilsHistFact::generate(wantPlots, plotsfile);
...
void FitterUtilsSimultaneousHistFact::fit(bool wantplot, bool constPartReco,
      ...
      ofstream& out, TTree* t, bool update, string plotsfile)
{
  ...
  //***************** Build model   
   ...
   //                                                      *l1Kee, *l2Kee, *l3Kee, *l4Kee, *l5Kee, m_binning, pT_binning);
   RooExpOfPolyTimesX* KemuPDF = new RooExpOfPolyTimesX("kemuPDF", "kemuPDF",  *B_plus_M, *misPT,  
                                                        l1Kemu, *l2Kee, *l3Kee, *l4Kee, *l5Kee, m_binning, pT_binning);
   ...
   model.addPdf(*model_pdf_constrain,channelName);  
   // model.addPdf(*model_nocomb_pdf,idx->getLabel());
   idx->defineType("Kemu");
   model.addPdf(KemuPDF,"Kemu");
...
void FitterUtilsSimultaneousHistFact::plot_kemu_fit_result(string plotsfile, RooAbsPdf &totKemuPdf, RooDataSet const& dataGenKemu)
{
