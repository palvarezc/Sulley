...
FitterUtils::FitterUtils(string name_, const Options &opts_)
  :name(name_),
   m_wantplot(false),
...
void FitterUtils::initiateParams(RooArgSet parset, RooArgSet constraints, RooArgSet parset_const)
{
...
double FitterUtils::prepare_component_PDF_ee(string filename, string treename, 
...
void FitterUtils::prepare_PDFs(int fitmode)
{
...
void FitterUtils::prepare_PDFs_ee()
{
   ...
   string BkgCut_prc = TrigCutString + " && " + MassCutString;
...
double FitterUtils::prepare_component_PDF_mumu( string filename, string treename, 
					     string compname, string cuts,  
					     RooArgSet varset, RooWorkspace *workspace,
					     string binningName)
{
...
void FitterUtils::prepare_PDFs_mumu()
{
...
void FitterUtils::generate_component(string compname, RooArgSet varset, int nGenComp, 
...
void FitterUtils::generate(int fitmode)
{
...
void FitterUtils::generate_ee()
{
   ...
   generate_component("SignalZeroGamma", *argset, opts.nGenSignalZeroGamma, workspace, workspaceGen);
   generate_component("SignalOneGamma", *argset, opts.nGenSignalOneGamma, workspace, workspaceGen);
   generate_component("SignalTwoGamma", *argset, opts.nGenSignalTwoGamma, workspace, workspaceGen);
...
void FitterUtils::generate_mumu()
{
...
void FitterUtils::run_toy(double fracPartReco_const,
...
void FitterUtils::fit_ee(RooDataSet* dataset_ee, RooDataSet* dataset_Kemu, 
			 ...
			 ofstream& out, TTree* t, bool update)
{
   ...
   RooRealVar nComb("nComb", "#nComb", mincomb, opts.nGenComb+100*sqrt(opts.nGenComb)); //1.*opts.nGenComb, opts.nGenComb-10*sqrt(opts.nGenComb), opts.nGenComb+10*sqrt(opts.nGenComb));
...
void FitterUtils::fit_mumu(RooDataSet* datasetTot, RooWorkspace* workspace, 
                      double fracPartReco_const,
                      ofstream& out, TTree* t, bool update)
{
...
void FitterUtils::fit_RK(RooDataSet* dataset_ee, RooDataSet* dataset_mumu, RooDataSet* dataset_Kemu,  
...
void FitterUtils::plot_fit_result(RooAbsPdf &totPdf, RooDataSet dataGenTot)
{
...
void FitterUtils::plot_mumu_fit_result(RooAbsPdf &totPdf, RooDataSet dataGenTot)
{
...
void FitterUtils::plot_kemu_fit_result(RooAbsPdf &totKemuPdf, RooDataSet datasetKemu)
{
...
void FitterUtils::PlotShape(RooDataSet& originDataSet, RooDataSet& genDataSet, RooAbsPdf& shape, string plotsfile, 
...
void FitterUtils::PlotShape2D(RooDataSet& originDataSet, RooDataSet& genDataSet, RooAbsPdf& shape, string plotsfile, 
...
void FitterUtils::PlotShape1D(RooDataSet& originDataSet, RooDataSet& genDataSet, RooAbsPdf& shape, string plotsfile, 
...
void FitterUtils::initiateParams(RooRealVar const& expoConstGen, RooRealVar& nSignal, RooRealVar& nPartReco, 
