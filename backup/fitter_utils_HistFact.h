...
class FitterUtilsHistFact
{
  ...
  FitterUtilsHistFact(int nGenSignal_, int nGenPartReco_, int nGenComb_, int nGenJpsiLeak_, double nGenFracZeroGamma_, double nGenFracOneGamma_, string workspacename_, string histofilename_);
  ...
  double make_base_histogram(string componentName, string componentFile, string componentTree,
